...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		ca.add(3);
		ca.sub(4);
		System.out.println(ca.circle(3));
		
		
		Computer cp = new Computer();
		System.out.println("원의 넓이는 : " + cp.circle(3));
		System.out.println("정사각형의 넓이는 : " + cp.rect(2));
		System.out.println("직사각형의 넓이는 : " + cp.rect(2, 3));
		System.out.println("직육면체의 넓이는 : "+ cp.rect(1, 2, 3));
